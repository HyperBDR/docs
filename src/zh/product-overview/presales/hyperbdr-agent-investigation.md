...
完成以下步骤，收集源端生产环境中容灾主机的信息并填写到CSV文件中（[CSV 模板文件下载](https://downloads.oneprocloud.com/Host%28Windows%20or%20Linux%29%20Quick%20Investigation%20information%20template.xlsx)）。然后使用 [Google 表单](https://docs.google.com/forms/d/1ikUHJxwYqeYmfBuk2Tl7Fy1I9aYIqvlFsSsg21rqfTs/prefill) CSV文件上传给我们。
...
[CSV模板文件下载](https://downloads.oneprocloud.com/Host%28Windows%20or%20Linux%29%20Quick%20Investigation%20information%20template.xlsx).  
